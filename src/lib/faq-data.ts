...
Go to the home screen and click on “Increase Transaction Limit.”
There you’ll find tasks that, once completed, will earn you RP.
...
Note: If you see a “Not Eligible” error during verification, it means you didn’t meet the required criteria to earn RP from that task.`,
  ...
  {
    id: 'social-verification-fail',
    question: 'Why is my social verification not working on P2P.me?',
    answer: `Social Verification only works if your account meets the required criteria.
If your profile matches the system’s standards, then it will be verified — otherwise, it won’t.
Also, you cannot reach the transaction milestone or perform transactions without earning RP.`,
  ...
  },
  {
    ...
    answer: `By default, new users can place only one order per day.
If they wish to place a second order on the same day, they must verify their account through the provided verification process.
They can place up to 10 sell orders as usual.`,
    category: 'Getting Started & Account',
  },
  {
    ...
    answer: `Hey!
On joining the group, you will see a welcome message along with a request to verify yourself.
Once you complete the verification, you will be able to send messages in the group.
...
Read the article to know more: https://x.com/p2pdotme/status/1938274354024091839`,
  ...
  },
  {
    ...
    answer: `If your account gets frozen by p2p.me, then we will help you to unfreeze it.
We have a dedicated team to unfreeze accounts. To date, we have completed over 35,000 orders without any bank freezes. We have a reputation system which doesn't allow frauds.`,
    category: 'Security & Privacy',
  },
  {
    id: 'government-data-zk-kyc',
...
The platform uses a ZK-Social Verification system that blocks fraudsters from ever accessing the protocol.
With over 32,000 transactions completed, there have been zero account freeze incidents.

2. Second-degree protection:
Users are advised to use a separate bank account exclusively for P2P offramps.
This minimizes risk by keeping your main financial accounts isolated.
Opening a new account is easy through services like Jio Payments Bank or Airtel Payments Bank in India.

3. Third-degree protection:
In the rare event that your account is frozen, the legal team at Unfreeze.in will assist you in unfreezing it completely free of charge.
...
Since P2P.me is a decentralized protocol, it cannot file or pay taxes on your behalf — you are required to handle your tax obligations independently.`,
  ...
  },
  {
    ...
    answer: `The Reclaim Protocol generates zero-knowledge (ZK) proofs on the client-side, meaning within the user's device.
This ensures that users maintain control over their data and cryptographic operations, as the ZK proofs are created locally without relying on third-party servers.`,
    category: 'Security & Privacy',
  },
  {
    id: 'scan-and-pay-legal',
    ...
    answer: `The "Scan & Pay" method is designed to divide incoming USDC into smaller UPI transactions, which are then paid out to regular vendors or shops.
In cases where suspicious or fraudulently sourced INR is converted into USDC and then used via Scan & Pay, the money trail typically ends at the merchant level due to this fragmentation. While P2P.me merchant accounts may sometimes face freezes from banks or authorities, P2P.me offers full refund support for affected merchants.
For shopkeepers or vendors receiving payments through legitimate merchant current accounts, any impact is minimal and can usually be resolved by submitting a simple affidavit to the bank or cybercrime authorities. P2P.me also provides free support in such cases to ensure smooth resolution.`,
    category: 'Security & Privacy',
  },
  {
    id: 'daily-transactions',
    question: 'How many transactions can I do per day?',
    answer: `Per day, there are 5 buy orders and 10 sell orders.
...
Both platforms offer low gas fees and support a wide range of chains.`,
  ...
  },
  {
    ...
    answer: `Become a merchant on P2P.me.
...
As a merchant on P2P.me, you are responsible for ensuring compliance with your local laws and tax regulations. Please consult with local experts to understand your compliance requirements.`,
  ...
  },
  {
    ...
    answer: `P2P.me is a decentralised protocol, similar to Uniswap but designed for Fiat/Crypto swaps.
Like any decentralised system, its legality depends on local regulatory interpretation, but the protocol itself is neutral, global, and permissionless.`,
...
This helps prevent fraud, financial crimes, and money laundering.`,
  ...
  },
  {
    ...
    answer: `Some jurisdictions mistakenly treat decentralised protocols like centralised businesses, leading to access restrictions.
Using a VPN bypasses this, and P2P.me is engaging with regulators to promote understanding, not evasion.`,
    category: 'General & Legal',
  },
  {
    id: 'alternatives',
